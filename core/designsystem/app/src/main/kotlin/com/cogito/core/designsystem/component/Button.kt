...
fun CogitoOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = CogitoButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = CogitoButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
 ...
 */
@Composable
private fun CogitoButtonContent(
    text: @Composable () -> Unit,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
    if (leadingIcon != null) {
...
@ThemePreviews
@Composable
fun CogitoButtonPreview() {
    CogitoTheme {
        CogitoBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            CogitoButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun CogitoOutlinedButtonPreview() {
    CogitoTheme {
        CogitoBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            CogitoOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun CogitoButtonLeadingIconPreview() {
    CogitoTheme {
        CogitoBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            CogitoButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = CogitoIcons.Add, contentDescription = null) },
            )
        }
    }
}
